 ...
 */
var paces:[String:Double]=["facil":10.0,"medio":8.0,"rapido":6.0]
...
if let removida=paces.removeValue(forKey: "sprint"){
    print(removida)
}
...
if let ritmo=paces["medio"]{
    print("¡De acuerdo! Mantendré tu ritmo a \(ritmo) un kilómetro y medio por minuto.")
}
