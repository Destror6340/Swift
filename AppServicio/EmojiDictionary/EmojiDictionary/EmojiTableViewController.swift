...
//  EmojiDictionary
//
//  Created by MacBook 28 on 05/12/22.
//
...
class EmojiTableViewController: UITableViewController {
    ...
    var emojis: [Emoji] = [
       ...
       "completion"),
       Emoji(symbol: "🫥", name: "no face",
                            description: "A very serious face", usage:
                            "completion")
]
    @IBAction func unwindCancel(unwindSegue: UIStoryboardSegue){}
    
    @IBAction func unwindToEmojiTableViewWithSegue(unwindSegue: UIStoryboardSegue){
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //Dequeue cell, as my EmojiTabelViewCell
